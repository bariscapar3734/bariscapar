...
class almanyadin extends StatefulWidget {
  @override
  _almanyadinState createState() => _almanyadinState();
}

class _almanyadinState extends State<almanyadin> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.black54,
        title: Text("Almanya Din"),
        centerTitle: true,
      ),
