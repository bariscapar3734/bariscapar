...
class almanyaaskeri extends StatefulWidget {
  @override
  _almanyaaskeriState createState() => _almanyaaskeriState();
}

class _almanyaaskeriState extends State<almanyaaskeri> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.black54,
        title: Text("Almanya Askeri Gücü"),
        centerTitle: true,
      ),
