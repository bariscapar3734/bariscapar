...
class almanyatarih extends StatefulWidget {
  @override
  _almanyatarihState createState() => _almanyatarihState();
}

class _almanyatarihState extends State<almanyatarih> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.black54,
        title: Text("Almanya Tarih"),
        centerTitle: true,
      ),
